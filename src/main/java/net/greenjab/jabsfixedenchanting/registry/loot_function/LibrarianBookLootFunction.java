package net.greenjab.jabsfixedenchanting.registry.loot_function;
...
public class LibrarianBookLootFunction extends LootItemConditionalFunction {
    ...
    private ItemStack masterBook(LootContext context, Optional<HolderSet<Enchantment>> option) {
        ...
        List<Villager> list = context.getLevel().getEntitiesOfClass(Villager.class, AABB.unitCubeFromLowerCorner(context.getOptional(LootContextParams.ORIGIN)).inflate(32), EntitySelector.LIVING_ENTITY_STILL_ALIVE);
